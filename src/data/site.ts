...
export const CERTS = {
  quality: ['ISO 9001:2015', 'ISO 14001:2015', 'OHSAS 18001:2007', 'SA 8000', 'BSCI'],
  materials: ['GOTS (Control Union)', 'OCS', 'GRS', 'Oeko-Tex', 'BCI', 'FSC Viscose', 'Higg Index 3.0'],
...
export const ESG_PLANET = [
  { metric: '12,600+', unit: 'trees', body: 'Planted across Noida green belts (2020 · 2021 · FY22–23).' },
  { metric: '300M+', unit: 'litres / yr', body: 'Groundwater recharge from two restored ponds in Ghaziabad.' },
  { metric: '343', unit: 'KW solar', body: 'Renewable electricity across three units — and rising.' },
